...
<section id="bucketlist-selection">
    ...
    <div class="page-content">
        ...
        <div class="row bucketlist-list">
            ...
            <div class="col-sm-6 col-md-4">
                <article class="well img-frame bucketlist-list-item" tabindex="1" ng-click="bucketlist.new({title:'Sky Diving', img:'http://www.bucketlist.net/site_media/media/thumbnails/Anonymous/19/19_jpg_320x320_crop_upscale_detail_q85.jpg',description: 'A little scared of heights and fancy the thrill of it ',alreadySaved: 0})">
                    <div class="img-container">
            ...
            <div class="col-sm-6 col-md-4">
                <article class="well img-frame bucketlist-list-item" tabindex="1" ng-click="bucketlist.new({title:'Get a Tattoo', img : 'http://www.bucketlist.net/site_media/media/thumbnails/Anonymous/28/28_jpg_320x320_crop_upscale_detail_q85.jpg', description: 'A tattoo is a commitment. Whatever is is it has to mean the world to me. ', alreadySaved: 0})">
                    <div class="img-container">
            ...
            <div class="col-sm-6 col-md-4">
                <article class="well img-frame bucketlist-list-item" tabindex="1" ng-click="bucketlist.new({title:'Other', img :'http://www.bucketlist.net/site_media/media/thumbnails/Anonymous/410/410_jpg_320x320_crop_upscale_detail_q85.jpg', alreadySaved: 0})">
                    <div class="img-container">
